...
#
get_filename_component(filename "C:/Users/joseh.EMANUELLE/Documents/Asteroids_in_C/cmake-build-debug/_deps/raylib-tmp/5.5.tar.gz" ABSOLUTE)
get_filename_component(directory "C:/Users/joseh.EMANUELLE/Documents/Asteroids_in_C/cmake-build-debug/_deps/raylib-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-raylib${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-raylib${i}")
